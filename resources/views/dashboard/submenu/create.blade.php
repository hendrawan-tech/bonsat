    ...
    <div class="col-lg-4">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Form Submenu</h6>
            </div>
            <div class="card-body">
                <form action="/dashboard/managements/submenu" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <input type="text" name="submenu" value="{{old('submenu')}}" class="form-control @error('submenu') is-invalid @enderror" placeholder="Submenu">
                                @error('submenu')
